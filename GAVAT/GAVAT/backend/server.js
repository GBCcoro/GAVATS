...
// Ejemplo: POST /api/cliente/comentarios, GET /api/catalogo/productos/:productoId/comentarios, PUT /api/admin/comentarios/:comentarioId/moderar
...
// Ejemplo: POST /api/cliente/facturas, GET /api/cliente/facturas/:numeroFactura/descargar, GET /api/admin/facturas
...
const startServer = async () => {
  try {
    ...
    console.log('🚀 Iniciando servidor GAVAT Backend...\n');
