 ...
 */
router.get('/admin/facturas', verificarAuth, esAdminOAuxiliar, facturaController.listarFacturasAdmin);

/**
 * GET /api/admin/facturas/:id
 * Ver detalle completo de una factura
 */
router.get('/admin/facturas/:id', verificarAuth, esAdminOAuxiliar, facturaController.verDetalleFactura);

/**
 * GET /api/admin/facturas/:numeroFactura/descargar
 * Descargar el PDF de una factura (admin)
 */
router.get('/admin/facturas/:numeroFactura/descargar', verificarAuth, esAdminOAuxiliar, facturaController.descargarFacturaPDFAdmin);
 ...
 * Body: { motivo: string }
 */
router.put('/admin/facturas/:id/anular', verificarAuth, esAdminOAuxiliar, facturaController.anularFactura);
