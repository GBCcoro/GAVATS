...
// Controlador de comentarios → desde controllers/comentario.controller.js
...
// Body esperado: { estado: "pendiente" | "pagado" | "en_proceso" | "enviado" | "entregado" | "cancelado" }
...
// Alias compatible: acepta PUT /api/admin/pedidos/:id para actualizar el estado también
router.put('/pedidos/:id', pedidoController.actualizarEstadoPedido);

// ==========================================
// RUTAS DE COMENTARIOS - ADMIN (/api/admin/comentarios)
// ==========================================

// Las rutas de comentarios de administrador se manejan ahora en /api mediante comentarios.routes.js
// ==========================================
// EXPORTAR ROUTER
// ==========================================
