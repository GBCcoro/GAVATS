...
const seedDatosCompletos = async () => {
  try {
    ...
    const categoriasData = [
      {
        nombre: "Ventanas",
        descripcion: "Instalacion de ventanas en aluminio y vidrio",
      },

      {
        nombre: "Puertas",
        descripcion: "Instalacion de puertas en vidrio y aluminio",
      },
      ...
      {
        nombre: "Cerramientos",
        descripcion: "Cerramientos en vidrio para espacios",
      },

      {
        nombre: "Estructuras",
        descripcion: "Estructuras en aluminio y vidrio",
      },
    ];
