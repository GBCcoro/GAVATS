...
const Usuario = sequelize.define('Usuario', {
  ...
  // Opcional durante el registro, puede completarse después.
  nombre: {
    type: DataTypes.STRING(100),       // VARCHAR(100) en MySQL → máximo 100 caracteres
    allowNull: true,                   // Opcional durante el registro
    validate: {
      len: {
        args: [2, 100],                // Si se proporciona, entre 2 y 100 caracteres
