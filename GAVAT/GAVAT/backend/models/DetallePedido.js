...
const DetallePedido = sequelize.define(
  "DetallePedido",
  {
    ...
    pedidoId: {
      ...
      allowNull: false, // Obligatorio:  detalle pertenece a un pedido

      references: {
        // Define la relación FK en MySQL
    ...
    productoId: {
      ...
      allowNull: false, // Obligatorio:  detalle tiene un producto
  ...
  },
  {
     ...
     */
      ...
      beforeCreate: (detalle) => {
        ...
        detalle.subtotal =
          Number.parseFloat(detalle.precioUnitario) * detalle.cantidad;
      },
