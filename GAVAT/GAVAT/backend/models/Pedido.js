...
const Pedido = sequelize.define('Pedido', {
  ...
  // Flujo normal: pendiente → pagado → en_proceso → enviado → entregado
  ...
  estado: {
    type: DataTypes.ENUM(              // ENUM en MySQL → solo permite estos valores exactos
      ...
      'en_proceso',                    // En proceso de preparación/logística
  ...
  // Columna 'metodoPago' → Método de pago seleccionado por el cliente
  // Ejemplo: 'efectivo', 'tarjeta', 'transferencia'
  metodoPago: {
